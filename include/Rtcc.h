 ...
 * 
 * $Log: Rtcc.h,v $
 * Revision 1.1.1.1  2006/10/18 20:57:37  wilkiec
 * prebuilt versions
 *
 * Revision 1.1.1.1  2006/10/05 21:41:35  wilkiec
 * original sources
 *
 *
 * Revision 1.1  2006/07/08
 * Initial import of RTCC Peripheral Library module.
 *
 *****************************************************************************/
...
********************************************************************/
#define mRtccSetAlrmPtr(mask)   (ALCFGRPT |= ALCFGRPT_MASK_ALRMPTR)
 ...
 * Note:            None.
 ********************************************************************/
#define mRtccSetInt(enable)   (EC3bits.RTCIE=enable)
...
#define MAX_MIN         (59)   /* BCD codification for minutes, 00-59 */
#define MAX_SEC         (59)   /* BCD codification for seconds, 00-59 */
#define MAX_WDAY        (6)    /* BCD codification for day of the week, 00-06 */
#define MAX_HOUR        (24)   /* BCD codification for hours, 00-24 */
#define MAX_MON         (12)   /* BCD codification for month, 01-12 */
#define MIN_MON         (1)
#define MAX_MDAY        (31)   /* BCD codification for day of the month, 01-31 */
#define MIN_MDAY        (1)
#define MAX_YEAR        (99)   /* BCD codification for year, 00-99 */
