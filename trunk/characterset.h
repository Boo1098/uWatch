...
extern const unsigned char AMPM_A[];
extern const unsigned char AMPM_P[];
extern const unsigned char AMPM_M[];
extern const unsigned char characterEllipsis[];
extern const unsigned char characterEllipsis2[];
extern const unsigned char characterEnter[];
extern const unsigned char left[];
extern const unsigned char right[];
extern const unsigned char character_Monday[];
extern const unsigned char character_Tuesday[];
extern const unsigned char character_Wednesday[];
extern const unsigned char character_Thursday[];
...
extern const unsigned char character_bold3[];
extern const unsigned char character_bold4[];
extern const unsigned char character_bold5[];
extern const unsigned char character_bold6[];
extern const unsigned char character_bold7[];
